...
class AreaAnalyzer:
    def __init__(self):
        ...
        self.AREA_REPORTS_DIR = f"/home/niranjan_yash/Emergin_Mult/Emerging_Multiplier_Architectures/Yash/{n_bits}x{n_bits}/reports/area_reports"
        self.SCRIPT_DIR = f"/home/niranjan_yash/Emergin_Mult/Emerging_Multiplier_Architectures/Yash/{n_bits}x{n_bits}/scripts/area_script"
        self.SUMMARY_FILE = f"/home/niranjan_yash/Emergin_Mult/Emerging_Multiplier_Architectures/Yash/{n_bits}x{n_bits}/summary/{verbose}_summary_area.txt"
