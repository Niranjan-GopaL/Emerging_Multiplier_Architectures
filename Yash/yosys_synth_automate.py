...
def create_synth_script(script_path, design, basename:str):
    ...
    with open(script_path, "w") as script_file:
        script_file.write(f"""
read_verilog /home/niranjan_yash/Emergin_Mult/Emerging_Multiplier_Architectures/Yash/{n_bits}x{n_bits}/rtl/{design}
hierarchy -check -top {module_name}
flatten
synth -top {module_name}
abc -liberty {LIB_PATH}
# write_json /home/niranjan_yash/Emergin_Mult/Emerging_Multiplier_Architectures/Yash/{n_bits}x{n_bits}/netlists/{verbose}-{basename}_netlist.json
write_verilog -noattr /home/niranjan_yash/Emergin_Mult/Emerging_Multiplier_Architectures/Yash/{n_bits}x{n_bits}/gate_level_netlists/{verbose}-temp_gate_level.v
""")
