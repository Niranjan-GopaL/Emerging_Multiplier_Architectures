...
def create_synth_script(script_path, design, basename:str):
    ...
    with open(script_path, "w") as script_file:
        script_file.write(f"""
read_verilog /home/nira/Documents/code/ece/Emerging_Multiplier_Architectures/src/{n_bits}x{n_bits}/rtl/{design}
hierarchy -check -top {basename}
flatten
synth -top {basename}
dfflibmap -liberty {LIB_PATH}
abc -liberty {LIB_PATH}
write_json /home/nira/Documents/code/ece/Emerging_Multiplier_Architectures/src/{n_bits}x{n_bits}/netlists/{verbose}-{basename}_netlist.json
write_verilog -noattr /home/nira/Documents/code/ece/Emerging_Multiplier_Architectures/src/{n_bits}x{n_bits}/gate_level_netlists/{verbose}-{basename}_gate_level.v
""")
